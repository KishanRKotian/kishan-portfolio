      ...
      <section id="about" className="section-padding">
        <div className="container-custom">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">Engineer with a focus on quality, innovation, and growth. Dedicated to creating meaningful solutions while learning and evolving in the ever-changing tech landscape.</p>
          </div>
